...
param customScriptFileUri string = 'https://${hanaStorageAccountName}.blob.core.windows.net/${containerName}/install-hana-sles2.sh'
...
resource vmCustomScript 'Microsoft.Compute/virtualMachines/extensions@2023-03-01' = {
  ...
  properties: {
    ...
    settings: {
      ...
      commandToExecute: 'bash install-hana-sles2.sh ${hanaStorageAccountName}'
    }
  }
}
